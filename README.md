...
- **Attachment API compatibility**: `src/upload.ts` writes the GIF to Revenge's
  native cache and opens Discord's native upload prompt. It falls back to a
  static PNG link when that private client API changes.
