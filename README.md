...
- **APNG delivery**: `src/upload.ts` writes the GIF to Revenge's native cache
  and sends a multipart attachment directly to Discord. It falls back to a
  static PNG link when Discord rejects the upload.
